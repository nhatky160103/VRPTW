...
depot_xy = torch.tensor([[0.0, 0.0]], dtype=torch.float32)  # (batch, 2) -> tọa độ depot
...
travel_matrix, routes_matrix, routes_demand = init_travel_time_demand(depot_xy, node_xy, node_demand, service_time,  node_indices, truck_num)
